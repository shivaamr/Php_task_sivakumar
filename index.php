...
<body>
  ...
  <header id="header">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.php">Kss Task<span>.</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto getstarted" href="admin/adminlogin.php">Admin Login</a></li>
          <?php
  ...
  <section id="hero">
    ...
    <div class="container">
      ...
      <div class=" col-lg-6 py-5 py-lg-0 order-2 order-lg-1" data-aos="fade-right">
        <h1>Upload Excel file Into Database</h1>
